...
class SQLiteHelper(context: Context?) : SQLiteOpenHelper(context, DB_NAME, null, 1) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("INSERT INTO WORDS_SET_TABLE(WORD_0, WORD_1, WORD_2, WORD_3, WORD_4, WORD_5, WORD_6, WORD_7, WORD_8, WORD_9) VALUES('Лес', 'Хлеб', 'Окно', 'Стул', 'Вода', 'Брат', 'Конь', 'Гриб', 'Игла', 'Мёд', 'Огонь')")
